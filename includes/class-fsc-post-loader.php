...
class FSC_Post_Loader
{
    ...
    public function get_posts_ajax()
    {
        ...
        if (empty($query_args)) {
            wp_send_json_error(__('No query parameters provided.', 'flexible-slider-and-carousel'));
        }
    ...
    private function build_post_meta($post_id, $post_elements)
    {
        ...
        if ($comments_count > 0) {
            $meta .= sprintf(
                ...
                sprintf(
                    _n('%s comment', '%s comments', $comments_count, 'flexible-slider-and-carousel'),
    ...
    private function build_post_author($post_id)
    {
        ...
        return sprintf(
            ...
            esc_html__('By', 'flexible-slider-and-carousel'),
            esc_url($author_url),
    ...
    private function build_post_categories($post_id)
    {
        ...
        return sprintf(
            ...
            esc_html__('Categories', 'flexible-slider-and-carousel'),
    ...
    private function build_post_tags($post_id)
    {
        ...
        return sprintf(
            ...
            esc_html__('Tags', 'flexible-slider-and-carousel'),
            implode(', ', $tag_links)
        );
    }
    ...
    private function get_no_posts_message()
    {
        return sprintf(
            ...
            esc_html__('No posts found matching your criteria.', 'flexible-slider-and-carousel')
        );
    }
